...
// 18
{
  ...
  textbox(slide, "Sterke promptregel: “citeer het bewijs”", 350, 525, 580, 60, {
    size: 26, bold: true, color: C.burgundy, align: "center",
  });
...
// 22
{
  const slide = base("Maak leren zichtbaar, niet AI onzichtbaar", "Toetsontwerp", 22);
  threeColumns(slide, [
...
// 26
{
  ...
  threeColumns(slide, [
    ...
    { kicker: "GRENS", title: "Grenzen", body: "Welke data?\nWelk besluit?\nWanneer stop je?" },
    { kicker: "TEST", title: "Morgen testen", body: "Kleine taak\nMeet kwaliteit\nDeel bevinding" },
  ], { y: 360, bodySize: 22, titleSize: 27, h: 200 });
