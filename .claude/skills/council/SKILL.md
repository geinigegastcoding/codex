...
**Path:** `E:\MData\Kennis\company\councils\{sanitized-topic}-council.md`
...
- If that path is unavailable, fall back to
  `C:\Users\Daniël\Desktop\Codex\Kennis\company\councils\{sanitized-topic}-council.md`.
...
**Path:** `E:\MData\Kennis\company\councils\{sanitized-topic}-council-deliverable.md`
