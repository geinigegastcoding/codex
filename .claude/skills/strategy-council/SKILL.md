...
**Path:** `E:\MData\Kennis\company\councils\{sanitized-topic}-strategy-council.md`

- Sanitize the topic to a filesystem-safe slug (lowercase, hyphens, no
  special characters).
- Create the `E:\MData\Kennis\company\councils` directory if it does not exist.
- If that path is unavailable, fall back to
  `C:\Users\Daniël\Desktop\Codex\Kennis\company\councils\{sanitized-topic}-strategy-council.md`.
...
**Path:** `E:\MData\Kennis\company\councils\{sanitized-topic}-strategy-council-deliverable.md`
