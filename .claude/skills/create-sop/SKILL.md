---
name: create-sop
description: Create a highly detailed, token-optimized SOP (Standard Operating Procedure) for a specified topic, incorporating context from the Kennis folder, and saving it to E:\MData\Kennis\company\SOP's\<topic>-SOP.md.
---
# create-sop Skill
...
3. **File Output**:
   ...
   - Save the file directly to `E:\MData\Kennis\company\SOP's/<sanitized-topic-name>-SOP.md`.
   - Ensure the directory `E:\MData\Kennis\company\SOP's` exists (create it if needed).
