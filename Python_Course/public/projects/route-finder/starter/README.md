...
The starter smoke tests pass. The project verifier intentionally fails until the implementation marker is removed and `examples/route-report.json` exists.
