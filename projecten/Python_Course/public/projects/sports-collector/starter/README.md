# Responsible Sports Data Collector
...
The starter smoke tests pass. The project verifier intentionally fails until the implementation marker is removed and `data/clean/sports-records.json` exists.
